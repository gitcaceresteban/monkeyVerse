...
Beyond genealogy, time-series and events, v2 records the tree of species, a feed
of automatically-detected historical milestones, and a rolling set of compact
keyframes that power the time machine (scrub back through the planet's past).
"""
...
CREATE TABLE IF NOT EXISTS stats (
    ...
    avg_energy REAL, avg_generation REAL, max_generation INTEGER, species INTEGER,
    herbivores INTEGER, carnivores INTEGER, sound_activity REAL, pher_activity REAL,
...
class Persistence:
    ...
    def log_stats(self, r):
        ...
        self._stats.append((r["tick"], r["population"], r["births"], r["deaths"], r["avg_energy"],
                            r["avg_generation"], r["max_generation"], r["species"], r["herbivores"],
                            r["carnivores"], r["sound_activity"], r["pher_activity"], r["veg_total"],
    ...
    def summary(self):
        ...
        return {"total_agents_ever": total, "total_deaths": deaths, "species_ever": spp,
                "milestones": ms, "last_stats": dict(last) if last else None}
